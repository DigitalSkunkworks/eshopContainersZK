...
namespace Microsoft.eShopOnContainers.Services.Identity.API.Configuration
{
    public class Config
    {
        ...
        {
            trace.Record(Annotations.LocalOperationStart("Config:GetResources"));
            var tmp = new List<IdentityResource>
            {
        ...
        {
            trace.Record(Annotations.LocalOperationStart("Config:GetClients"));
